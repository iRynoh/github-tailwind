  ...
  <div class='text-gray-900 text-sm'>
    <nav class='bg-gray-900 text-white px-8 py-4 flex items-center justify-between'>
      <div class='flex items-center space-x-4'>
        ...
        <div class='relative'>
          <input type='text' class='rounded bg-gray-900 border border-gray-600 placeholder-white w-72 px-3 py-1'
      ...
      <div class='flex items-center space-x-4 text-white'>
        ...
        <a href='#' class='flex items-center hover:text-gray-400'>
          <img src='https://avatars.githubusercontent.com/u/11317914?s=60&amp;v=4' alt='@iRynoh'
    ...
    <div class='flex items-center justify-between px-8 py-4'>
      <div class='flex'>
        ...
        <div class='flex items-center text-xl ml-2'>
          <a href='#' class='text-blue-600 hover:underline'>iRynoh</a>
          <span class='ml-1'>/</span>
          <a href='#' class='text-blue-600 hover:underline ml-1 font-semibold'>github-tailwind</a>
        </div>
      </div>
      <div class='flex space-x-2'>
        <div class='flex text-xs'>
          <button class='border border-gray-300 rounded rounded-r-none px-3 py-1 flex items-center space-x-1'>
            <svg class='w-4 fill-current text-gray-500' viewBox='0 0 16 16' aria-hidden='true'>
              <path fill-rule='evenodd'
          ...
          <a href='#'
             class='border border-gray-300 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1'>430</a>
        </div>
        <div class='flex text-xs'>
          <button class='border border-gray-300 rounded rounded-r-none px-3 py-1 flex items-center space-x-1'>
            <svg class='w-4 fill-current text-gray-500' viewBox='0 0 16 16' aria-hidden='true'>
          ...
          <a href='#'
             class='border border-gray-300 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1'>39.9k</a>
        </div>
        <div class='flex text-xs'>
          <button class='border border-gray-300 rounded rounded-r-none px-3 py-1 flex items-center space-x-1'>
            <svg class='w-4 fill-current text-gray-500' viewBox='0 0 16 16' aria-hidden='true'>
          ...
          <a href='#'
             class='border border-gray-300 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1'>1.8k</a>
        </div>
      </div>
    </div>
    <!-- end repo-stats -->
    ...
    <ul class='border-b border-gray-300 flex items-center px-8 mt-4'>
      ...
      <li>
        <a href='#'
          ...
          <svg class='w-4 fill-current text-gray-400' viewBox='0 0 16 16' aria-hidden='true'>
            <path fill-rule='evenodd'
          ...
          <div class='text-xs rounded-lg bg-gray-200 px-2 ml-1'>84</div>
        </a>
      </li>
      <li>
        <a href='#'
          ...
          <div class='text-xs rounded-lg bg-gray-200 px-2 ml-1'>32</div>
        </a>
      </li>
      <li>
        <a href='#'
          ...
          <span class='ml-2'>Discussions</span></a>
      </li>
      <li>
        <a href='#'
           class='flex items-center border-b-2 border-transparent hover:border-gray-300 transition ease-in-out duration-150 px-4 pb-3'>
